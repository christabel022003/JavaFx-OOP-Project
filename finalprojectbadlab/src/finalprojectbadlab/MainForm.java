...
public class MainForm implements EventHandler<ActionEvent>{
	Scene scene;
	...
	TransactionHistory.setOnAction(new EventHandler<ActionEvent>() {
		...
		@Override
		public void handle(ActionEvent arg0) {
			window3 = new Window("Transactions");
			window3.getContentPane().getChildren().add(new Transactions().box);
		    borderContainer.setCenter(window3);
		}
	});
